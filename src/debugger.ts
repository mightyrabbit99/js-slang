...
export let DebugLocation: es.SourceLocation | null | undefined
export let lastContext: Context
export let dummyItValue = { value: 'DEBUGGER TOGGLED', done: true, debugger: true }
...
export function storeCurrentStatus(
  context: Context,
